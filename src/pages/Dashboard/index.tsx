      ...
      <Container>
        <CardContainer>
          <Card>
            ...
            <h1 data-testid="balance-income">{balanceState.income}</h1>
          </Card>
          <Card>
            <header>
              <p>Saídas</p>
            ...
            <h1 data-testid="balance-outcome">{balanceState.outcome}</h1>
          </Card>
          <Card total>
            <header>
              <p>Total</p>
            ...
            <h1 data-testid="balance-total">{balanceState.total}</h1>
          </Card>
        </CardContainer>
